...
import scss from '../scss/welcome_message.scss'
		...
		<React.Fragment>
			<header>
				<div className="menu">
					<ul>
						...
						<li className="menu-item hidden">
							<a href="https://forum.codeigniter.com/" target="_blank">Community</a></li>
						<li className="menu-item hidden">
				...
				<section>
					...
					<h2>
						<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 512 512'>
							<rect x='32' y='96' width='64' height='368' rx='16' ry='16' style={{fill:'none',stroke:'#000',strokeLinejoin:'round',strokeWidth:'32px'}}/>
							<line x1='112' y1='224' x2='240' y2='224' style={{fill:'none',stroke:'#000',strokeLinecap:'round',strokeLinejoin:'round',strokeWidth:'32px'}}/>
							<line x1='112' y1='400' x2='240' y2='400' style={{fill:'none',stroke:'#000',strokeLinecap:'round',strokeLinejoin:'round',strokeWidth:'32px'}}/>
							<rect x='112' y='160' width='128' height='304' rx='16' ry='16' style={{fill:'none',stroke:'#000',strokeLinejoin:'round',strokeWidth:'32px'}}/>
							<rect x='256' y='48' width='96' height='416' rx='16' ry='16' style={{fill:'none',stroke:'#000',strokeLinejoin:'round',strokeWidth:'32px'}}/>
							<path d='M422.46,96.11l-40.4,4.25c-11.12,1.17-19.18,11.57-17.93,23.1l34.92,321.59c1.26,11.53,11.37,20,22.49,18.84l40.4-4.25c11.12-1.17,19.18-11.57,17.93-23.1L445,115C443.69,103.42,433.58,94.94,422.46,96.11Z' style={{fill:'none',stroke:'#000',strokeLinejoin:'round',strokeWidth:'32px'}}/>
						</svg>
						Learn
					</h2>
					...
					<h2>
						<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 512 512'>
							<path d='M431,320.6c-1-3.6,1.2-8.6,3.3-12.2a33.68,33.68,0,0,1,2.1-3.1A162,162,0,0,0,464,215c.3-92.2-77.5-167-173.7-167C206.4,48,136.4,105.1,120,180.9a160.7,160.7,0,0,0-3.7,34.2c0,92.3,74.8,169.1,171,169.1,15.3,0,35.9-4.6,47.2-7.7s22.5-7.2,25.4-8.3a26.44,26.44,0,0,1,9.3-1.7,26,26,0,0,1,10.1,2L436,388.6a13.52,13.52,0,0,0,3.9,1,8,8,0,0,0,8-8,12.85,12.85,0,0,0-.5-2.7Z' style={{fill:'none',stroke:'#000',strokeLinecap:'round',strokeMiterlimit:'10',strokeWidth:'32px'}}/>
					...
					<h2>
						 <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 512 512'><line x1='176' y1='48' x2='336' y2='48' style={{fill:'none',stroke:'#000',strokeLinecap:'round',strokeMiterlimit:'10',strokeWidth:'32px'}}/><line x1='118' y1='304' x2='394' y2='304' style={{fill:'none',stroke:'#000',strokeLinecap:'round',strokeMiterlimit:'10',strokeWidth:'32px'}}/><path d='M208,48v93.48a64.09,64.09,0,0,1-9.88,34.18L73.21,373.49C48.4,412.78,76.63,464,123.08,464H388.92c46.45,0,74.68-51.22,49.87-90.51L313.87,175.66A64.09,64.09,0,0,1,304,141.48V48' style={{fill:'none',stroke:'#000',strokeLinecap:'round',strokeMiterlimit:'10',strokeWidth:'32px'}}/></svg>
						 Contribute
					</h2>
			...
			<footer>
				<div className="environment">
					<p>Page rendered in 0.333 seconds</p>
...
function App(){
	return(
		<Router>
			<Switch>
				<Route path="/" component={WelcomeMessages}/>
			</Switch>
		</Router>
	)
}
